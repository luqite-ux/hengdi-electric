...
export function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-[#031329] pt-16 text-white">
      ...
      <div aria-hidden className="hero-surface-flow pointer-events-none absolute right-[24%] top-[48%] hidden h-24 w-[34%] -rotate-1 overflow-hidden rounded-full lg:block" />
      <div aria-hidden className="hero-cabinet-reflection pointer-events-none absolute right-[4%] top-[12%] hidden h-[64%] w-[24%] overflow-hidden lg:block" />
